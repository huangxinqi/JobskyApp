 ...
 */
@Entity
@Table(name = "TempDemandInfo", schema = "dbo", catalog = "jobskynet8")
public class TempDemandInfoBean {
    private int tempDemandId;
    ...
    @Id
    @Column(name = "TempDemandID", nullable = false)
    public int getTempDemandId() {
        return tempDemandId;
    }

    public void setTempDemandId(int tempDemandId) {
        this.tempDemandId = tempDemandId;
    }
    ...
    public boolean equals(Object o) {
        ...
        TempDemandInfoBean that = (TempDemandInfoBean) o;

        if (tempDemandId != that.tempDemandId) return false;
